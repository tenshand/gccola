...
# 青龙面板加入环境变量Mt_Version和MTokenD
# MTokenD是茅台预约参数，多个请换行，格式'省份,城市,经度,维度,设备id,token,MT-Token-Wap(抓包小茅运)'
# Mt_Version是app版本号如 1.3.6 必填（填最新版本，目前好像没法获取）
# MT-Token-Wap参数是小茅运的领奖励，不需要的话MTokenD格式改成 省份,城市,经度,维度,设备id,token,''
